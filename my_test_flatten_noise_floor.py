...
with h5py.File(r"C:\Users\Tim\PycharmProjects\parrot\parrot\example_data\Formatted_2024-05-29_Cd3As2_reprate_40.0kHz_power_30.0mW_pos_-94.00mm_120.00mm.h5", 'r') as f:
    key_1 = list(f.keys())
...
process_obj = parrot.Process()
data2 = process_obj.dark_only(dark2, scale=50e-12 / 20, delay_value=-2, debug=False)
